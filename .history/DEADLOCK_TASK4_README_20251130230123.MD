...
2. **Experimental Results**
    ...
    |:----------|:----------|:----------|:----------|:----------:|:----------|:----------:|
    | `case_no_deadlock.pnml` | Simple loop structure, infinite run. | NO DEADLOCK | NO DEADLOCK | 6 | 0.00205 | PASS |
    | `case_choice_deadlock.pnml` | Non-deterministic choice leading to a sink state. | DEADLOCK | DEADLOCK | 2 | 0.00066 | PASS |
